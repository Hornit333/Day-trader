...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull LinearLayout rootView, @NonNull TextView priceText,
      @NonNull TextView symbolText) {
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((LinearLayout) rootView, priceText, symbolText);
    }
